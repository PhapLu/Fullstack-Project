...
router.patch('/toggleMuteConversation/:conversationId', asyncHandler(conversationController.toggleMuteConversation))
router.get('/readConversation/:conversationId/readMessages', asyncHandler(conversationController.readMessages))
