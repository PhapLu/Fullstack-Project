    ...
    <section className={`${styles.popular} ${styles.container}`} id="popular">
      <div className={`${styles.popular__header}`}>
        ...
        <div className={styles.filterWrap}>
          ...
          {panelOpen && (
            <div className={styles.filterPanel} ref={panelRef} role="dialog" aria-label="Filter and sort by price">
              <div className={styles.option}>
                ...
                <div className={styles.rangeRow}>
                  ...
                  <input
                    ...
                    className={styles.priceInput}
                  />
                  <button type="button" className={styles.applyBtn} onClick={applyRange}>
                    Apply
                  </button>
                </div>
              </div>
