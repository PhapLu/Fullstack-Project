...
export default function PopularProducts() {
    ...
    useEffect(() => {
        setCurrentPage(1);
    }, [mode, minPrice, maxPrice, processed]);

    // Get current products
    const indexOfLastProduct = currentPage * productsPerPage;
    const indexOfFirstProduct = indexOfLastProduct - productsPerPage;
    const currentProducts = processed.slice(
        indexOfFirstProduct,
        indexOfLastProduct
    );
    ...
    const applyRange = () => {
        ...
        if (mode === "asc" || mode === "desc") query.sort = mode;
    ...
    const clearFilters = () => {
        ...
        setMinPrice("");
        setMaxPrice("");
        fetchProducts(); // reload all without filters/sort
        setPanelOpen(false);
    };
