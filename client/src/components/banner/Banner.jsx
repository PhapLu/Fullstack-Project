...
const Banner = () => {
        ...
        () => [
            {
                ...
                desc: (
                    <>
                        Zosmo places a big sale! Save up to
                        <br />
            ...
            },
            {
                ...
                desc: (
                    <>
                        Premium headphones — immersive bass,
                        <br />
                        lightweight comfort.
                    </>
                ),
    ...
    return (
        <section className={`${styles.banner} ${styles.container}`}>
            <button
                className={`${styles["banner-arrow"]} ${styles.left}`}
                onClick={prev}
                aria-label="Previous"
            >
                ‹
            ...
            <div
                className={`${styles["banner-card"]} ${styles.fade}`}
            ...
            <button
                className={`${styles["banner-arrow"]} ${styles.right}`}
                onClick={next}
                aria-label="Next"
            >
                ›
