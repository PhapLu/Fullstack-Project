...
export default function OrdersLayout() {
    ...
    const buildAddress = (order) => {
        ...
        const diAddr =
            di.address ||
            [di.street, di.ward, di.district, di.city]
                .filter(Boolean)
                .join(", ");
    ...
    return (
        <div className="orders-layout container-fluid py-4 d-flex flex-column"
            style={{ minHeight: "65vh" }}
        >
            {orders.length === 0 ? (
                <section className="flex-grow-1 d-flex align-items-center justify-content-center">
                    <div
                        className="card border-0 shadow-sm px-4 py-5 text-center w-100"
                    >
						...
						<p className="text-muted mb-4 fs-5">
                            Explore our latest items and deals. Your orders will
                            show up here after checkout.
                        </p>
                    ...
                    <div key={order._id} className="card mb-3 shadow-sm">
                        <div className="card-body">
                            ...
                            <div className="d-flex justify-content-end mt-2">
                                <strong>
                                    Total: ${orderTotal(order).toLocaleString()}
                                </strong>
                            </div>
                        </div>
                    </div>
