      ...
      <div className="row gy-4">
                ...
                <div key={p.id} className={`card p-3 shadow-sm rounded-4 border-0 ${styles["hover-card"]}`}>
                  <div className="d-flex gap-3 align-items-center">
                    ...
                    <div className="flex-grow-1">
                      ...
                      <div className="mt-2 fw-semibold">{vnd(p.price)}</div>
                    </div>
                  ...
                  {p.stock && p.qty >= p.stock && (
                    <div className="text-danger small mt-2">Out of stock limit.</div>
                  )}
                </div>
              ))}
              <div>
        ...
        <div className="col-lg-4">
          ...
          <div className={`card p-3 mb-3 shadow-sm rounded-4 border-0 ${styles["hover-card"]}`}>
            ...
            {coupon && <div className="small text-success mt-2">Mock: −{vnd(50000)}</div>}
          </div>
          ...
          <div className={`card p-3 shadow-sm rounded-4 border-0 ${styles["hover-card"]}`}>
            ...
            <hr className="my-2" />
            <div className="d-flex justify-content-between">
              <span>Delivery:</span><span>{vnd(delivery)}</span>
            </div>
            <hr className="my-2" />
            <div className="d-flex justify-content-between fw-bold">
              <span>Total Payable:</span><span>{vnd(total)}</span>
            </div>
            <button
