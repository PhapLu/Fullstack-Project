    ...
    (async () => {
      ...
      try {
        ...
        setPricing({
          subtotal:
            p.subtotal ??
            normItems.reduce((s, i) => s + i.priceAtPurchase * i.quantity, 0),
          shippingFee: p.delivery ?? 2,
          total:
            p.total ??
            (p.subtotal ??
              normItems.reduce(
    ...
    try {
      ...
      if (arr.length > 0) {
        if (
          preserveSelection &&
          selectedDeliveryId &&
          arr.some((d) => String(d._id) === String(selectedDeliveryId))
        ) {
          return;
        }
    ...
    <div className="container py-4">
      ...
      <div className="card mb-3 shadow-sm">
        <div className="card-body p-4">
          ...
          {showCreateForm && (
            <form onSubmit={onCreateSubmit} className="border rounded p-3 mb-3">
              <div className="row g-3">
                ...
                <div className="col-md-6">
                  <label className="form-label fs-7 fw-semibold">Phone *</label>
                  <input
                    className="form-control form-control-lg"
                ...
                <div className="col-12">
                  <select
                    ...
                    value={createInputs.distributionHubId ?? ""}
                    onChange={(e) =>
                      setCreateInputs({
                        ...createInputs,
                ...
                >
                  ...
                  >
                    <input
                      ...
                      name="delivery"
                      value={String(d._id)}
                      checked={String(selectedDeliveryId) === String(d._id)}
                    ...
                    <div>
                      ...
                      <div className="fs-7 mt-2">{d.address || ""}</div>
                    </div>
                  </label>
                  ...
                  >
                    {deletingId === String(d._id) ? "Deleting..." : "Delete"}
                  </button>
                </div>
              ))}
            </div>
        ...
        <div className="card-body">
          ...
          {["cash", "card"].map((m) => (
            ...
            >
              ...
              />
              <label className="form-check-label mb-0" htmlFor={`pay-${m}`}>
