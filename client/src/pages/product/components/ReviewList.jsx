...
export default function ReviewList({ productId }) {
  ...
  return (
    <div className="vstack gap-5 pt-5 pb-5">
      {reviews.map((r) => (
        <div key={r._id} className="d-flex gap-3 align-items-start mb-3">
          {/* Avatar */}
          <img
            src={
          ...
          <div className="flex-grow-1">
            ...
            >
              <span className="fw-bold fs-3">{user.fullName || user.username}</span>
            </div>
            ...
            <div className=" ps-1">
              ...
              {/* Comment */}
              <div className="text-body mt-2">{r.comment}</div>
            </div>
          </div>
        </div>
      ))}
